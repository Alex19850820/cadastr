<?php
/**
 * cadastr functions and definitions
 *
...
if ( ! function_exists( 'cadastr_setup' ) ) :
	/**
	 ...
	 */
	function cadastr_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on cadastr, use a find and replace
		 * to change 'cadastr' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'cadastr', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'cadastr' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'cadastr_custom_background_args', array(
...
add_action( 'after_setup_theme', 'cadastr_setup' );
 ...
 */
function cadastr_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'cadastr_content_width', 640 );
}
add_action( 'after_setup_theme', 'cadastr_content_width', 0 );
 ...
 */
function cadastr_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'cadastr' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'cadastr' ),
...
add_action( 'widgets_init', 'cadastr_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function cadastr_scripts() {
	/*
   * Подключаем стили:
   * Аргументы:
   ...
   */
	...
	wp_enqueue_style( 'cadastr-style', get_stylesheet_uri() );
	
	wp_enqueue_style( 'cadastr-style-fonts_google', '//fonts.googleapis.com/css?family=Work+Sans:300,700,800%7COswald:300,400,500' );
	
	wp_enqueue_style( 'cadastr-style-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.css' );
	...
	wp_enqueue_script( 'cadastr-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
    ...
    */
	wp_localize_script( 'cadastr-js_script__form', 'myajax',
		[
