...
//    //ключ - slug опции, к которому будем обращаться во view
	...
	'h1_first'     => [
		'type'  => 'text',
		'value' => 'Пройдем проверку',
		'label' => __('Заголовок 2', '{domain}'),
	],
	'h1_second'     => [
		'type'  => 'text',
		'value' => 'без штрафных санкций!',
		'label' => __('Заголовок 2', '{domain}'),
	],
	'desc'     => [
		'type'  => 'textarea',
		'value' => 'Являюсь специалистом в
области трудового права и кадрового делопроизводства. Опыт свыше 17
лет. Работаю со средним и крупным бизнесом.
',
